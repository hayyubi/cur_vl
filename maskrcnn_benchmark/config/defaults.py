...
_C.DATASETS.DATASET_ARGS.DEBUG = False
...
# Includes dataset numbers for those which uses whole image for inference
# instead of BBoxes
_C.DATASETS.DATASET_ARGS.INFERENCE_FROM_IMAGE = []
# Reduce training datasize for ablation
_C.DATASETS.DATASET_ARGS.REDUCE_TO_PERCENT = -1.0
# Use combined noun and noun phrase while training
_C.DATASETS.DATASET_ARGS.WORD_N_NOUN_PHRASE = False
# Seed for random data selection
_C.DATASETS.DATASET_ARGS.SEED = 0
...
_C.MODEL.LANGUAGE_BACKBONE.USE_PRETRAINED = True
...
# Scale Transformer head
_C.MODEL.MMSS_HEAD.SCALE_TH = -1.0
...
_C.MODEL.MMSS_HEAD.GROUNDING.ALIGNMENT_CURRICULUM = ""
...
# Config for extracting BBox. 
_C.MODEL.BBOX = CN()
# Can be either GT or RP for automatic extraction from a rpn n/w.
_C.MODEL.BBOX.TYPE = "GT"
# If using RPN for bbox, provide a config to build the RPN model
_C.MODEL.BBOX.RPN = CN()
_C.MODEL.BBOX.RPN.CFG = ""
## Path where RPN model's weight is stored
_C.MODEL.BBOX.RPN.WEIGHT = ""
...
# For Phased Inference
_C.TEST.PHASED_INFERENCE = False
...
_C.CURRICULUM = CN()
_C.CURRICULUM.DO = False
_C.CURRICULUM.NUM_PHASES = 1
_C.CURRICULUM.ITERS = ()
_C.CURRICULUM.PHASES_FILE = ""
_C.CURRICULUM.NOUNS_ONLY = False
_C.CURRICULUM.NOUNS_PHASES_FILE = ""

# During inference
_C.INFERENCE = CN()
_C.INFERENCE.DO = False